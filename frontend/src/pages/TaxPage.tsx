...
import { getBookToTax, getChecklist, getPriorYears, uploadTaxDocs } from '../api'
  ...
  return (
    <div className="space-y-4">
      ...
      <Card
        ...
        action={
          <a className="text-xs text-emerald-600 hover:underline" href={`/api/clients/${clientId}/tax/lead-sheet.xlsx`}>
            Download lead sheet
          </a>
        }
      >
